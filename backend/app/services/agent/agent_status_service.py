...
# Agent 状态服务 — 封装 app.agents.status 模块
class AgentStatusService:

    # 返回 5 个 Agent 的最新状态 + 最近 50 条事件历史
    def get_status(self) -> dict:
        from app.agents.status import get_agents_status as _get
        return _get()
