      ...
      <div className="card-dash bg-base-200">
        ...
        {showForm && (
          <div className="flex flex-wrap items-end gap-3 mb-3 p-3 rounded-xl bg-base-100/50 border border-base-300">
            ...
            <div><label className="text-[11px] text-base-content/40 font-semibold block mb-1">初始资金</label><FormInput type="number" value={String(capital)} onChange={v => setCapital(Number(v))} min={10} className="w-28" /></div>
